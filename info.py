...
BOT_TOKEN = environ.get('BOT_TOKEN', "5277636826:AAFDo-R22GFKb-TiEisOEKfEgC5A61T99X0")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/7a6cf188934a744bdb560.jpg https://graph.org/file/e619c02d67c29c0714e35.jpg')).split() #SAMPLE PIC
...
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/b39b61791f49f9c713c89.jpg")
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/DowPCMOffcL/2') # How to open tutorial link for verification
...
BOT_NAME = environ.get("BOT_NAME", "Nᴀɴᴄʏ")
BOT_ID = environ.get("BOT_ID", "5277636826")
S_GROUP = environ.get('S_GROUP', "PCMBotsG")
S_CHANNEL = environ.get('S_CHANNEL', "PCMBots")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/xeonflixmovies')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/XeonFlix')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/DowPCMOffcL/8') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
