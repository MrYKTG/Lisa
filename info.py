...
OWNER_ID = environ.get('OWNER_ID', '821215952')
BOT_TOKEN = environ.get('BOT_TOKEN', "7937175433:AAFj8r8MG1mpBmOG6yLxGDihNIWDBd59ZDg")

# for eval function, work only in a specific group
EVAL_ID = environ.get("EVAL_ID", "-1002434717011")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '821215952 5115691197').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002444169959').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001542373688') #Channel / Group Id for force sub ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://YKDB04:YKDB04@cluster0.b0fk0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
AI_LOGS = int(environ.get("AI_LOGS", "-1001763711197")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of Bot ]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001763711197')) #Log channel id ( make sure bot is admin )
...
BOT_USERNAME = environ.get("BOT_USERNAME", "AutoFilterXeonBot")
BOT_NAME = environ.get("BOT_NAME", "𝐋ᴜᴄʏ")
BOT_ID = environ.get("BOT_ID", "5277636826")
S_GROUP = environ.get('S_GROUP', "weebs_support")
S_CHANNEL = environ.get('S_CHANNEL', "codeflix_bots")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/XeonBots')
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : Xeon ʙᴏᴛs')
